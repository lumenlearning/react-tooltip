...
export default class Tooltip extends React.Component{
  ...
  toggleHover(e){
    ...
    if(e.type == 'mouseenter' || e.type == 'mouseover'){
      this.props.mouseEnterCallback(e, this.state.hover, true);
      hover = true;
    }
    else if(e.type == 'mouseleave' || e.type == 'mouseout'){
      this.props.mouseLeaveCallback(e, this.state.hover, false);
      hover = false;
    }
    else if(e.type == 'mousemove'){
      this.props.mouseMoveCallback(e, this.state.hover, true);
      hover = true;
    }
  ...
  tooltipStyle(){
    ...
    let zIndex      = this.state.hover ? '1' : '-1000';

    return _.merge({visibility: visibility, zIndex: zIndex}, style.tooltip, this.positionStyle(this.props.position), this.props.style || {});
  }
...
Tooltip.propTypes = {
  ...
  mouseEnterCallback: React.PropTypes.function,
  mouseLeaveCallback: React.PropTypes.function,
  mouseMoveCallback: React.PropTypes.function,
};
